        ...
        <section id="services" className="services section-bg">
            <div className="container" data-aos="fade-up">
                <header className="section-header">
                    <h3>¿Qué ofrecemos?</h3>
                    <p>Descubre los beneficios de estudiar con Education360.</p>
                </header>
                ...
                <div className="row">
                    <div className="col-md-6 col-lg-4 wow bounceInUp" data-aos="zoom-in" data-aos-delay={100}>
                        <div className="box">
                            ...
                            <h4 className="title text-center"><a>Plataforma intuitiva</a></h4>
                    ...
                    <div className="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay={200}>
                        <div className="box">
                            ...
                            <h4 className="title text-center"><a>Cursos y libros digitales</a></h4>
                    ...
                    <div className="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay={300}>
                        <div className="box">
                            ...
                            <h4 className="title"><a>Potenciar tu carrera profesional</a></h4>
