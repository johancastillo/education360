...
const PopularCourses = () => {
    ...
    const filterApp = () => setFilter('app')
    const filterCard = () => setFilter('card')
    const filterWeb = () => setFilter('web')
              ...
              <div className="row" data-aos="fade-up" data-aos-delay={100}>
                <div className="col-lg-12">
                  <ul id="portfolio-flters">
                    ...
                    <li className={filter === 'app' ? "filter-active" : ""}
                    onClick={filterApp}>
                      App
                    </li>

                    <li className={filter === 'card' ? "filter-active" : ""}
                    onClick={filterCard}>
                      Card
                    </li>

                    <li className={filter === 'web' ? "filter-active" : ""}
                    onClick={filterWeb}>
                      Web
                    </li>
                  </ul>
